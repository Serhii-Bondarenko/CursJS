...
const f5 = () => {
    ...
    document.querySelector('.out-5').textContent = s5.size.toString();
...
const f7 = () => {
    ...
    if (str.length === set.size && set.size > 6) {
...
const f8 = () => {
    ...
    for (const num of s8) {
        ...
        if (num > 5 && !ar8.includes(num)) ar8.push(num);
...
document.querySelector('.b-9').onclick = () => {
    ...
    document.querySelector('.out-9').innerText = f9(s9);
}
...
const f10 = (out_set, elem) => {
    ...
    document.querySelector(elem).innerText = [...out_set].join(' ');
...
const f13 = () => {
    ...
    let txtSet = new Set([...t]);

    for (const item of txtSet) {
