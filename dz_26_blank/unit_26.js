...
function request(actionParam, out, userName, num1, num2, bornYear, m = 1, d = 1, y = 1) {

    fetch(`http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=${actionParam}&name=${userName}&num1=${num1}&num2=${num2}&year=${bornYear}&m=${m}&d=${d}&y=${y}`)
        .then(response => response.text())
        .then(value => document.querySelector(out).textContent = value)
...
function postRequest(actionParam, out, userName, num1, num2, bornYear, m = 1, d = 1, y = 1) {
...
function t15() {
    ...
    fetch(`http://getpost.itgid.info/index2.php`, {
        ...
        body: `auth=7859d9d42a8834141d529577207c9596&action=6&num1=33&num2=22`

    })
        .then(response => response.text())
        .then(value => document.querySelector('.out-15').textContent = value)
