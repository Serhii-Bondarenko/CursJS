...
function f7() {
    a7[document.querySelector('.i-7').value] !== undefined ? document.querySelector('.out-7').innerHTML = 1 : document.querySelector('.out-7').innerHTML = 0;
}
...
function f8() {
    a8[document.querySelector('.i-8').value] !== undefined ? document.querySelector('.out-8').innerHTML = a8[document.querySelector('.i-8').value] : document.querySelector('.out-8').innerHTML = 0;
}
...
function f11() {
    for (const key in a11) {
        if (document.querySelector('.i-11').value === key) {
            delete a11[key];
        }
    }
    f5(a11, '.out-11');
...
function f12() {
    for (const key in a12) {
        if (+document.querySelector('.i-12').value === a12[key]) {
            delete a12[key];
        }
    }
    f5(a12, '.out-12');
...
function f13() {
    ...
    for (const key in a13) {
       typeof a13[key] === 'number' ? sum += a13[key] : false;
    }
...
function f16() {
    ...
    for (const key in a16) {
        for (const innerKey in a16[key]) {
            innerKey === 'name' ? out+= a16[key][innerKey] + ' ' : false;
        }
    }
...
function f17() {
    ...
    for (const key in a17) {
        for (const innerKey in a17[key]) {
           if(a17[key][innerKey] > 30){
               out += a17[key].name;
           }
        }
    }
...
function f19() {
    ...
    for (const key in a19) {
        for (const top of a19[key]) {
            if(i19.value.toLowerCase() === top.toLowerCase()){
                out += key;
            }
        }
    }
