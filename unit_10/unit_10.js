...
let ar2 = ['str', 25, NaN, 3>1, !!''] // переменную обьявляем здесь!!!!
...
let ar3 = ['2312', 'sdaasdas', 321131, 5==5, 5===5, 5!==5]  // переменную обьявляем здесь!!!!
...
function f16() {
    ...
    for (let i = 0; i < ar16_even.length; i++){
        evenOut += ar16_even[i] + ' ';
        out16Even.innerHTML = evenOut;
    }
    for (let i = 0; i < ar16_odd.length; i++){
        oddOut += ar16_odd[i] + ' ';
        out16Odd.innerHTML = oddOut;
    }
}
