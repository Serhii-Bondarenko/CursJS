...
function f6() {
    ...
    for (const item of a6) {
        ...
        for (const number of item) {
            ...
            document.querySelector('.out-6').innerText = out += number + ' ';
...
function f9() {
    ...
    let maxIndex = a9[0].length;

    for (const elem of a9) {
