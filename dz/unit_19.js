...
document.querySelector('.div-11').onmouseover = t11;
document.querySelector('.div-11 > img').onmouseleave = function a() {
    this.src = "img/1.png"
};
...
document.querySelector('.div-12').onmousedown = function t12() {
    this.classList.toggle('active')
};
...
document.querySelector('.div-13').onmousedown = function t13() {
    this.classList.add('active')
};
document.querySelector('.div-13').onmouseup = function t111() {
