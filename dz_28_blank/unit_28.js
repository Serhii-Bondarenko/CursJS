...
let coat = new GoodsImg('coat', 24, 'https://image.shutterstock.com/image-photo/long-woolen-coat-600w-296441669.jpg', 100)
...
coat.draw(document.querySelector('.out-4'));
...
let superCoat = new Goods2('coat', 231, 'https://image.shutterstock.com/image-photo/long-woolen-coat-600w-296441669.jpg', 100, 'true')

superCoat.draw(document.querySelector('.out-6'))
// Task 6.
...
let coat3 = new Goods3('COAT3', 2312, 'https://image.shutterstock.com/image-photo/long-woolen-coat-600w-296441669.jpg', 300, false);
coat3.draw(document.querySelector('.out-6'));
...
let data1 = new Valid('sdaweq@dasd.com', '1234567');
...
let data2 = new Valid2('sdaweq@dasd.com', '2321111');
...
let testData = new Valid2('', '12345678');
...
let testData1 = new Valid2('12345678', '12345678');
