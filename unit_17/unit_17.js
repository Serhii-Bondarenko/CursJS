...
function t4() {
    ...
    return a4_res = a4.filter(elem => typeof elem === 'number');
...
function t5() {
    ...
    return a5_res = a5.filter(num => typeof num === 'number' && num % 2 === 0)
...
function t6() {
    ...
    return a6_res = a6.filter(elem => typeof elem === 'number' && elem > 14);
...
function t7() {
    return a7_res = a7.map(title => title.toLocaleLowerCase());
}
...
function t9() {
    let newArr = [];
    a9.forEach(word => newArr.push(word.toLowerCase()));
    return a9 = newArr;
}
...
function t10() {
     ...
     return a10.map(num => num < 0 ? num = 0 : num);
...
function t11() {
    ...
    return a11_res = a11.filter((num, index) => index % 2 === 0)
...
function t14() {
    ...
    let lowerCaseStr = a14.map(letter => letter.toLowerCase());

    return lowerCaseStr.includes(a14_sym.toLowerCase());
...
function t15() {
    ...
    return a15_res = a15.filter(user => user.pnum.length);
